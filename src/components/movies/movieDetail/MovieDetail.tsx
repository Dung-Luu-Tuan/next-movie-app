...
import { Category, MoviesDetailProps } from "@/types";

const MoviesDetail: React.FC<MoviesDetailProps> = ({ movieDetail, movieEpisodes }) => {
    return (
        <>
            <Container className={classes.container}>
                <Container className={classes.detail}>
                    <Flex direction="column" justify="flex-start">
                        ...
                        <Group>
                            {movieDetail?.category?.map((item: Category, index: number) => (
                                <Button
                                    key={index}
                                    variant="default"
